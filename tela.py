...
class application():
    ...
    def widgets_frame_1(self):
        ...
        self.lb_codigo.place(relx = 0.076 , rely = 0.05)
        ...
        self.lb_nome.place(relx = 0.076 , rely = 0.35)

        self.nome_entry = Entry(self.frame_1)
        self.nome_entry.place(relx = 0.02 , rely = 0.45, relheight =0.1 , relwidth = 0.4)

        #Criação da lapel e entrada do Telefone
        self.lb_telefone = Label(self.frame_1, text = "Telefone")
        self.lb_telefone.place(relx = 0.076 , rely = 0.35)

        self.telefone_entry = Entry(self.frame_1)
        self.telefone_entry.place(relx = 0.02 , rely = 0.45, relheight =0.1 , relwidth = 0.4)

        #Criação da lapel e entrada do Cidade
        self.lb_cidade = Label(self.frame_1, text = "Cidade")
        self.lb_cidade.place(relx = 0.076 , rely = 0.35)

        self.cidade_entry = Entry(self.frame_1)
        self.cidade_entry.place(relx = 0.02 , rely = 0.45, relheight =0.1 , relwidth = 0.4)
